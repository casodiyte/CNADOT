...
const expertosRaw = [
  ...
  {nombre:'Enf. Laura Fernandez Lebrusán',pais:'ES',color:orange,org:'España',expertise:'Enfermera en Cuidados críticos en Hospital Universitario Puerta de Hierro Majadahonda.', foto:'assets/expertos/laura_fernandez_lebrusan.jpg', sintesis:'Enfermera de Cuidados Críticos en el Hospital Universitario Puerta de Hierro Majadahonda. Profesora en la Facultad de Ciencias de la Salud (Enfermería) de la Universidad Francisco de Vitoria. Máster en Urgencias y Cuidados Críticos Intrahospitalarios por la CEU San Pablo. Especialista HEMS y Máster en Dirección y Gestión Sanitaria.'},
  ...
  {nombre:'Dr. Aczel Isidoro Sánchez Cedillo',pais:'MX',color:green,org:'STALYC',expertise:'Presidente Sociedad de trasplante de América Latina y el Caribe STALYC.', foto:'assets/expertos/m._en_c._aczel_sanchez_cedillo.jpg', sintesis:'Médico Cirujano (UNAM) adscrito al Centro Médico ABC, con especialidad en Cirugía General y Cirugía de Trasplantes (INCMNSZ). Excoordinador Nacional de Trasplantes del ISSSTE y expresidente de la Sociedad Mexicana de Trasplantes. Actual presidente de la Sociedad de Trasplante de América Latina y el Caribe (STALYC).'},
  {nombre:'Dr. En Educ. Victor Manuel Figueroa Corchado',pais:'MX',color:blue,org:'Relámpagos',expertise:'Jefe de la unidad de rescate aéreo relámpagos, Estado de México.', foto:'assets/expertos/lic._victor_figueroa_corchado.jpg', sintesis:'Licenciado en Atención Médica Prehospitalaria. Técnico Profesional en Urgencias Médicas. Cuenta con diplomados en medicina de aviación (SCT/UNAM), aeromedicina y transporte de cuidados críticos, y toxicología clínica. Rescatista Aéreo Especializado y actual Jefe de la unidad de rescate aéreo Relámpagos en el Estado de México.'},
  ...
  {nombre:'Dr. José Moya Medina',pais:'MX',color:blue,org:'OPS',expertise:'Representante de la OPS/OMS México.', foto:'assets/expertos/dr._jose_moya_medina.jpg', sintesis:'Médico cirujano, epidemiólogo y experto en salud pública que actualmente se desempeña como el representante en México de la OPS/OMS. Cuenta con maestría en Salud Pública y especialidad en Epidemiología de Campo. Amplia trayectoria en el control de enfermedades y políticas de salud internacionales.'},
  {nombre:'Dr. Juan Salvador Rodríguez Jamaica',pais:'MX',color:blue,org:'CETRA GTO',expertise:'Director Médico en Centro Estatal de Trasplantes de Guanajuato.', foto:'assets/expertos/dr._juan_salvador_rodriguez_jamaica.jpeg', sintesis:'Médico Cirujano con Maestría en Dirección Estratégica de Organizaciones de Salud. Coordinador de Donación avalado por CENATRA y UNAM. Fellow en Donación y Trasplante de Órganos por el Gift of Life Institute. Actualmente es Director Médico del Centro Estatal de Trasplantes de Guanajuato.'},
  {nombre:'Dr. Patricio Santillán Doherty',pais:'MX',color:blue,org:'Bioética',expertise:'Titular de la Comisión Nacional de Bioética.', foto:'assets/expertos/dr._patricio_javier_santillan_doherty.jpg', sintesis:'Médico especialista en Cirugía Torácica. Fue jefe de Cirugía Experimental y presidente del Comité de Ética en el INCMNSZ. Exdirector Médico del Instituto Nacional de Enfermedades Respiratorias (INER). Actualmente funge como Titular de la Comisión Nacional de Bioética (CONBIOETICA).'},
  {nombre:'Dr. Rodrigo López Falcony',pais:'MX',color:blue,org:'CETRA GTO',expertise:'Director del Centro Estatal de Trasplantes del Estado de Guanajuato.', foto:'assets/expertos/dr._rodrigo_lopez_falcony.jpeg', sintesis:'Cirujano Urólogo y de trasplante renal. Director General del Centro Estatal de Trasplantes de la Secretaría de Salud de Guanajuato desde 2011. Expresidente de la Sociedad Mexicana de Trasplantes (2020-2021) y Council para América Latina de la ISODP de la Transplantation Society.'},
  {nombre:'Dr. Salvador Martínez Bernal',pais:'MX',color:blue,org:'Médico',expertise:'Especialista.', foto:'assets/expertos/dr_salvador_martinez_bernal.jpg', sintesis:'Médico Cirujano Militar egresado de la Universidad del Ejército y Fuerza Aérea. Posgrado en donación de órganos en el Hospital Clinic Barcelona (DTI-TPM). Diplomado Universitario en formación de coordinadores de donación por CENATRA/UNAM. Instructor nacional del curso "Comunicación en Situaciones Críticas".'},
  {nombre:'Dr. Walter Adolfo Querevalu Murillo',pais:'MX',color:blue,org:'IMSS',expertise:'Coordinador de donación del CMN Siglo XXl hospital de especialidades.', foto:'assets/expertos/dr._walter_adolfo_querevalu_murillo.jpg', sintesis:'Especialista en Medicina Interna y Maestro en Administración de Servicios de Salud. Diplomado de Formación de Coordinadores Hospitalarios de Donación (TPM España). Catedrático de la UNAM y actual Coordinador Hospitalario de Donación en el Hospital de Especialidades CMN Siglo XXI.'},
  {nombre:'Dra. Erika Rivera Duron',pais:'MX',color:blue,org:'IMSS',expertise:'Jefe de Área de trasplantes IMSS.', foto:'assets/expertos/dra._erika_rivera_duron.jpg', sintesis:'Subespecialista en Terapia Intensiva Neurológica. Diplomada en Formación de Coordinadores Hospitalarios de Donación (TPM España). Actualmente se desempeña como Jefa del Área de Órganos Intraabdominales de la Coordinación de Donación y Trasplantes de Órganos, Tejidos y Células del IMSS.'},
  {nombre:'Dra. Kenia Yazmin Reyes Gutierrez',pais:'MX',color:blue,org:'CETRA GTO',expertise:'Médico Coordinador de Donación de órganos y tejidos con fines de trasplante.', foto:'assets/expertos/dra__kenia_yazmin_reyes_gutierrez.jpeg', sintesis:'Médico Cirujano con Maestría en Administración de Instituciones Hospitalarias. Máster Internacional en Donación y Trasplante de Órganos, Tejidos y Células (ONT España). Instructora avalada en el curso de Comunicación en Situaciones Críticas y Médico Coordinador de Donación en el CETRA Guanajuato.'},
  {nombre:'Dra. Magdalena García Baysa',pais:'MX',color:blue,org:'CCINSHAE',expertise:'Directora de coordinación interinstitucional CCINSHAE.', foto:'assets/expertos/dra._magdalena_garcia_baysa.jpg', sintesis:'Médica Cirujana por la UNAM con Diplomado en Formación de Coordinadores Hospitalarios de Donación. Excoordinadora Hospitalaria de Donación en el INCMNSZ. Actualmente funge como Directora de Coordinación Interinstitucional en la CCINSHAE.'},
  {nombre:'Dra. Nubia Denisse Avilez Pacheco',pais:'MX',color:blue,org:'IMSS',expertise:'Jefa de Área Médica de donación IMSS.', foto:'assets/expertos/dra._nubia_denisse_avilez_pacheco.jpeg', sintesis:'Licenciatura en Medicina. Especialista en Urgencias. Maestría en Gestión de Hospitales. Doctorado en Alta Dirección de Hospitales. Diplomado de Formación de Coordinadores Hospitalarios de Donación, TPM España. Forma parte de la mesa directiva de la Sociedad Mexicana de Trasplantes. Jefa de Área de Donación en la Coordinación Nacional de Donación y Trasplantes del IMSS. Actualmente Encargada de la División de Donación y Trasplantes en la Coordinación Nacional de Donación y Trasplantes del IMSS.'},
  {nombre:'Dra. Reyna Moreno Ruiz',pais:'MX',color:blue,org:'INCICh',expertise:'Coordinadora Hospitalaria de Donación y Trasplante, Instituto Nacional de Cardiología Ignacio Chávez.', foto:'assets/placeholder_user.png', sintesis:'Maestría en Administración en Sistemas de Salud por la Facultad de Contaduría y Administración, División de Estudios de Posgrado, UNAM (2015-2017). Especialidad en Salud en el Trabajo por la Facultad de Estudios Superiores Zaragoza, UNAM (2007-2008). Licenciatura como Médico Cirujano por la Facultad de Medicina, UNAM (1999-2005). Extensa capacitación y experiencia en coordinación hospitalaria de donación de órganos y tejidos.'},
  {nombre:'Edgar Hernández Rendón',pais:'MX',color:blue,org:'IMSS',expertise:'Médico Adscrito a Cirugía Cardiotorácica Hospital de Cardiología CMN Siglo XXI.', foto:'assets/expertos/edgar_hernandez_rendon.jpeg', sintesis:'Médico Especialista en Cirugía Cardiotorácica. Con amplia experiencia clínica y académica en el campo de la salud cardiovascular y torácica. Actualmente se desempeña como Médico Adscrito a Cirugía Cardiotorácica en el Hospital de Cardiología del Centro Médico Nacional Siglo XXI.'},
  {nombre:'Lic. Enf. Gilberto Díaz Pérez',pais:'MX',color:blue,org:'Perfusión',expertise:'Enfermero Perfusionista y ECMO especialista en el Grupo ECMO-ECLS MÉXICO.', foto:'assets/expertos/lic._enf._gilberto_diaz_perez.jpeg', sintesis:'Teniente de Fragata Lic. Enf. Gilberto Díaz Pérez. Enfermero Naval por parte de la Escuela de Enfermería de la Armada de México. Licenciatura en Enfermería por la Universidad Veracruzana. Especialista en Terapia Intensiva y Cuidados Coronarios por la Escuela Militar de Graduados de Sanidad. Especialista en Tecnología Extracorpórea por el Instituto Nacional de Cardiología "Dr. Ignacio Chávez". Certificación de Soporte Extracorpóreo.'},
  {nombre:'Lic. Enf. Sulem Piña Ocampo',pais:'MX',color:blue,org:'HGM',expertise:'Adscrita a Torre Quirúrgica Hospital General de México Dr. Eduardo Liceaga.', foto:'assets/expertos/eeq_sulem_pina_ocampo.jpeg', sintesis:'Licenciada en Enfermería Quirúrgica adscrita a Torre Quirúrgica en el Hospital General de México Dr. Eduardo Liceaga, Servicio de Quirófano. Egresada de ENEO/UNAM. Cuenta con posgrado en el Instituto Tecnológico de Estudios Superiores y Ciencias de la Salud. Diplomada en "Atención de Enfermería en los Procesos de Donación y Trasplantes" por la UNAM y SMT. Rotación Formativa en Cirugía de Trasplante Hepático, Renal y Biliopancreática en el Hospital Clínic de Barcelona, España. Profesora titular y adjunta en múltiples capacitaciones de trasplantes. Miembro activo del Capítulo de Enfermería de la Sociedad Mexicana de Trasplantes.'},
  {nombre:'Mca. Cja Alma Itzel Martínez Vera',pais:'MX',color:blue,org:'Novoinjertos',expertise:'Coordinadora Médica en el Banco de Tejidos musculoesquelético y Piel Novoinjertos.', foto:'assets/placeholder_user.png', sintesis:'Médica cirujana egresada de la Universidad Nacional Autónoma de México. Realizó su internado médico en el Hospital General de México "Dr. Eduardo Liceaga" y su Servicio Social en el Instituto Nacional de Cardiología Ignacio Chávez. Cuenta con un Diplomado en coordinación de Donación de órganos y tejidos con fines de trasplante por el CENATRA. Es Técnico procurador de tejido corneal avalado por la UNAM y el Instituto de Oftalmología FAP Conde de Valenciana.'},
];
