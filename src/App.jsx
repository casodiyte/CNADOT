...
const BotonPrograma = ({ style }) => (
  <a
    href="assets/CNADOT_Programa_Completo.pdf"
    target="_blank"
    rel="noopener noreferrer"
    style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'linear-gradient(135deg, #1c5b76, #0099CC)', color: '#fff', fontFamily: "'Poppins'", fontWeight: 600, fontSize: 16, textDecoration: 'none', padding: '14px 30px', borderRadius: 999, boxShadow: '0 6px 18px rgba(28,91,118,.3)', transition: '.2s', ...style }}
  >
      ...
      <main style={{ position: 'relative', zIndex: 10, maxWidth: 1240, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        {section === 'programa' && (
          <section className="cn-reveal pad-section">
            ...
            <BotonPrograma style={{ marginBottom: 28 }} />
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {programa.map((f, i) => {
